...
router.get('/:userId/countApproved', auth('countApprovedEvidences'), evidenceController.countApprovedEvidences);
router.get('/:userId/countDeclined', auth('countDeclinedEvidences'), evidenceController.countDeclinedEvidences);
